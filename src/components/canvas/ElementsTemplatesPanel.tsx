...
const elementCategories: { title: string; icon: typeof Type; items: ElementItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Sidebar Nav', tag: 'nav', icon: Sidebar, description: 'Vertical nav menu', customHtml: '<nav style="width:220px;padding:16px;background:#f8fafc;border-radius:12px;border:1px solid #e2e8f0;"><div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:0.1em;color:#94a3b8;margin-bottom:12px;padding:0 12px;">Menu</div><a href="#" style="display:flex;align-items:center;gap:10px;padding:10px 12px;background:#6366f1;color:#fff;border-radius:8px;font-size:13px;font-weight:600;text-decoration:none;margin-bottom:2px;">📊 Dashboard</a><a href="#" style="display:flex;align-items:center;gap:10px;padding:10px 12px;color:#64748b;border-radius:8px;font-size:13px;font-weight:500;text-decoration:none;margin-bottom:2px;">👥 Users</a><a href="#" style="display:flex;align-items:center;gap:10px;padding:10px 12px;color:#64748b;border-radius:8px;font-size:13px;font-weight:500;text-decoration:none;margin-bottom:2px;">⚙️ Settings</a><a href="#" style="display:flex;align-items:center;gap:10px;padding:10px 12px;color:#64748b;border-radius:8px;font-size:13px;font-weight:500;text-decoration:none;">📄 Reports</a></nav>' },
      { label: 'Tab Bar', tag: 'div', icon: PanelTop, description: 'Horizontal tabs', customHtml: '<div style="display:flex;border-bottom:2px solid #e2e8f0;margin:16px 0;"><button style="padding:12px 20px;border:none;background:none;font-size:14px;font-weight:700;color:#6366f1;border-bottom:2px solid #6366f1;margin-bottom:-2px;cursor:pointer;">Active</button><button style="padding:12px 20px;border:none;background:none;font-size:14px;font-weight:500;color:#94a3b8;cursor:pointer;">Tab 2</button><button style="padding:12px 20px;border:none;background:none;font-size:14px;font-weight:500;color:#94a3b8;cursor:pointer;">Tab 3</button></div>' },
      { label: 'Bottom Nav', tag: 'nav', icon: PanelBottom, description: 'Mobile bottom bar', customHtml: '<nav style="display:flex;justify-content:space-around;align-items:center;padding:12px 0;background:#fff;border-top:1px solid #e2e8f0;border-radius:0 0 12px 12px;"><div style="display:flex;flex-direction:column;align-items:center;gap:4px;cursor:pointer;"><span style="font-size:20px;">🏠</span><span style="font-size:10px;font-weight:700;color:#6366f1;">Home</span></div><div style="display:flex;flex-direction:column;align-items:center;gap:4px;cursor:pointer;"><span style="font-size:20px;">🔍</span><span style="font-size:10px;font-weight:600;color:#94a3b8;">Search</span></div><div style="display:flex;flex-direction:column;align-items:center;gap:4px;cursor:pointer;"><span style="font-size:20px;">➕</span><span style="font-size:10px;font-weight:600;color:#94a3b8;">Create</span></div><div style="display:flex;flex-direction:column;align-items:center;gap:4px;cursor:pointer;"><span style="font-size:20px;">🔔</span><span style="font-size:10px;font-weight:600;color:#94a3b8;">Alerts</span></div><div style="display:flex;flex-direction:column;align-items:center;gap:4px;cursor:pointer;"><span style="font-size:20px;">👤</span><span style="font-size:10px;font-weight:600;color:#94a3b8;">Profile</span></div></nav>' },
      { label: 'Stepper', tag: 'div', icon: Activity, description: 'Step progress', customHtml: '<div style="display:flex;align-items:center;gap:0;margin:16px 0;"><div style="display:flex;align-items:center;gap:8px;"><div style="width:32px;height:32px;background:#6366f1;color:#fff;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;">✓</div><span style="font-size:13px;font-weight:600;color:#0f172a;">Account</span></div><div style="flex:1;height:2px;background:#6366f1;margin:0 12px;"></div><div style="display:flex;align-items:center;gap:8px;"><div style="width:32px;height:32px;background:#6366f1;color:#fff;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;">2</div><span style="font-size:13px;font-weight:600;color:#0f172a;">Details</span></div><div style="flex:1;height:2px;background:#e2e8f0;margin:0 12px;"></div><div style="display:flex;align-items:center;gap:8px;"><div style="width:32px;height:32px;background:#e2e8f0;color:#94a3b8;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;">3</div><span style="font-size:13px;font-weight:500;color:#94a3b8;">Confirm</span></div></div>' },
    ],
  },
  {
    title: 'E-Commerce',
    icon: CreditCard,
    items: [
      { label: 'Product Card', tag: 'div', icon: CreditCard, description: 'Shop product', customHtml: '<div style="max-width:280px;background:#fff;border:1px solid #e2e8f0;border-radius:16px;overflow:hidden;margin:16px 0;"><div style="aspect-ratio:1;background:linear-gradient(135deg,#f0f4ff,#e0e7ff);display:flex;align-items:center;justify-content:center;font-size:48px;">👟</div><div style="padding:16px;"><div style="display:flex;justify-content:space-between;align-items:start;"><h3 style="font-size:15px;font-weight:700;margin:0;color:#0f172a;">Product Name</h3><span style="font-size:13px;font-weight:800;color:#6366f1;">$49.99</span></div><p style="font-size:13px;color:#94a3b8;margin:6px 0 14px;">Short description here</p><div style="display:flex;gap:4px;margin-bottom:14px;color:#f59e0b;font-size:14px;">★★★★☆ <span style="color:#94a3b8;font-size:12px;margin-left:4px;">(128)</span></div><button style="width:100%;padding:12px;background:#0f172a;color:#fff;border:none;border-radius:10px;font-size:13px;font-weight:700;cursor:pointer;">Add to Cart</button></div></div>' },
      { label: 'Cart Item', tag: 'div', icon: CreditCard, description: 'Shopping cart row', customHtml: '<div style="display:flex;gap:16px;align-items:center;padding:16px;border:1px solid #e2e8f0;border-radius:12px;margin:8px 0;"><div style="width:80px;height:80px;background:#f1f5f9;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:28px;shrink:0;">📦</div><div style="flex:1;min-width:0;"><h4 style="font-size:14px;font-weight:700;margin:0 0 4px;color:#0f172a;">Product Name</h4><p style="font-size:12px;color:#94a3b8;margin:0;">Size: M · Color: Blue</p></div><div style="text-align:right;"><div style="font-size:15px;font-weight:800;color:#0f172a;">$49.99</div><div style="display:flex;align-items:center;gap:8px;margin-top:8px;"><button style="width:28px;height:28px;border:1px solid #e2e8f0;background:#fff;border-radius:6px;cursor:pointer;font-size:14px;">−</button><span style="font-size:13px;font-weight:700;">1</span><button style="width:28px;height:28px;border:1px solid #e2e8f0;background:#fff;border-radius:6px;cursor:pointer;font-size:14px;">+</button></div></div></div>' },
      { label: 'Price Tag', tag: 'div', icon: Tag, description: 'Price display', customHtml: '<div style="display:inline-flex;align-items:baseline;gap:8px;"><span style="font-size:36px;font-weight:900;color:#0f172a;">$29</span><span style="font-size:16px;color:#94a3b8;text-decoration:line-through;">$49</span><span style="padding:4px 10px;background:#dcfce7;color:#15803d;border-radius:999px;font-size:12px;font-weight:700;">-40%</span></div>' },
      { label: 'Checkout Summary', tag: 'div', icon: CreditCard, description: 'Order summary', customHtml: '<div style="max-width:360px;padding:24px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:16px;margin:16px 0;"><h3 style="font-size:16px;font-weight:800;margin:0 0 20px;color:#0f172a;">Order Summary</h3><div style="display:flex;justify-content:space-between;padding:8px 0;font-size:14px;color:#64748b;border-bottom:1px solid #e2e8f0;"><span>Subtotal</span><span style="font-weight:600;color:#0f172a;">$98.00</span></div><div style="display:flex;justify-content:space-between;padding:8px 0;font-size:14px;color:#64748b;border-bottom:1px solid #e2e8f0;"><span>Shipping</span><span style="font-weight:600;color:#10b981;">Free</span></div><div style="display:flex;justify-content:space-between;padding:8px 0;font-size:14px;color:#64748b;border-bottom:1px solid #e2e8f0;"><span>Tax</span><span style="font-weight:600;color:#0f172a;">$8.82</span></div><div style="display:flex;justify-content:space-between;padding:12px 0 0;font-size:18px;font-weight:900;color:#0f172a;"><span>Total</span><span>$106.82</span></div><button style="width:100%;margin-top:20px;padding:14px;background:#6366f1;color:#fff;border:none;border-radius:10px;font-size:15px;font-weight:700;cursor:pointer;">Checkout</button></div>' },
    ],
  },
  {
    title: 'Profile & User',
    icon: CircleUser,
    items: [
      { label: 'User Card', tag: 'div', icon: CircleUser, description: 'Profile summary', customHtml: '<div style="display:flex;align-items:center;gap:16px;padding:20px;background:#fff;border:1px solid #e2e8f0;border-radius:16px;margin:16px 0;"><div style="width:56px;height:56px;background:linear-gradient(135deg,#6366f1,#8b5cf6);border-radius:50%;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:20px;">JD</div><div style="flex:1;"><h4 style="font-size:16px;font-weight:700;margin:0 0 2px;color:#0f172a;">John Doe</h4><p style="font-size:13px;color:#94a3b8;margin:0;">john@example.com</p></div><button style="padding:8px 16px;background:#f1f5f9;border:none;border-radius:8px;font-size:12px;font-weight:600;color:#334155;cursor:pointer;">Edit</button></div>' },
      { label: 'Profile Header', tag: 'div', icon: CircleUser, description: 'Full profile top', customHtml: '<div style="text-align:center;padding:32px;background:linear-gradient(135deg,#0f172a,#1e293b);border-radius:16px;margin:16px 0;"><div style="width:80px;height:80px;background:linear-gradient(135deg,#6366f1,#a78bfa);border-radius:50%;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:28px;margin:0 auto 16px;border:4px solid rgba(255,255,255,0.15);">JD</div><h3 style="font-size:20px;font-weight:800;color:#fff;margin:0 0 4px;">Jane Doe</h3><p style="font-size:14px;color:rgba(255,255,255,0.5);margin:0 0 16px;">Senior Designer</p><div style="display:flex;justify-content:center;gap:32px;"><div><div style="font-size:20px;font-weight:900;color:#fff;">248</div><div style="font-size:11px;color:rgba(255,255,255,0.4);text-transform:uppercase;font-weight:700;">Posts</div></div><div><div style="font-size:20px;font-weight:900;color:#fff;">12.4K</div><div style="font-size:11px;color:rgba(255,255,255,0.4);text-transform:uppercase;font-weight:700;">Followers</div></div><div><div style="font-size:20px;font-weight:900;color:#fff;">891</div><div style="font-size:11px;color:rgba(255,255,255,0.4);text-transform:uppercase;font-weight:700;">Following</div></div></div></div>' },
      { label: 'Comment', tag: 'div', icon: Type, description: 'User comment', customHtml: '<div style="display:flex;gap:12px;padding:16px 0;border-bottom:1px solid #f1f5f9;"><div style="width:36px;height:36px;background:#6366f1;border-radius:50%;display:flex;align-items:center;justify-content:center;color:#fff;font-size:12px;font-weight:700;flex-shrink:0;">AB</div><div style="flex:1;"><div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;"><span style="font-size:13px;font-weight:700;color:#0f172a;">Alex Brown</span><span style="font-size:11px;color:#94a3b8;">2h ago</span></div><p style="font-size:14px;color:#475569;line-height:1.5;margin:0;">Great work! This looks amazing. Can\'t wait to see the final version.</p><div style="display:flex;gap:16px;margin-top:8px;"><button style="background:none;border:none;font-size:12px;color:#94a3b8;cursor:pointer;font-weight:600;">❤️ 12</button><button style="background:none;border:none;font-size:12px;color:#94a3b8;cursor:pointer;font-weight:600;">Reply</button></div></div></div>' },
      { label: 'Notification Item', tag: 'div', icon: Bell, description: 'Alert item', customHtml: '<div style="display:flex;align-items:flex-start;gap:12px;padding:14px 16px;background:#f0f4ff;border-radius:12px;margin:6px 0;"><div style="width:36px;height:36px;background:#6366f1;border-radius:10px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:14px;flex-shrink:0;">🔔</div><div style="flex:1;"><p style="font-size:13px;color:#0f172a;margin:0;line-height:1.5;"><strong>New follower</strong> — Sarah started following you.</p><span style="font-size:11px;color:#94a3b8;">3 minutes ago</span></div><div style="width:8px;height:8px;background:#6366f1;border-radius:50%;margin-top:6px;flex-shrink:0;"></div></div>' },
    ],
  },
  {
    ...
    icon: BarChart3,
    items: [
      { label: 'Bar Chart', tag: 'div', icon: BarChart3, description: 'Horizontal bars', customHtml: '<div style="padding:24px;background:#fff;border:1px solid #e2e8f0;border-radius:16px;margin:16px 0;"><h4 style="font-size:14px;font-weight:700;margin:0 0 20px;color:#0f172a;">Revenue by Month</h4><div style="display:flex;flex-direction:column;gap:10px;"><div style="display:flex;align-items:center;gap:12px;"><span style="font-size:12px;color:#64748b;width:30px;">Jan</span><div style="flex:1;height:24px;background:#e2e8f0;border-radius:6px;overflow:hidden;"><div style="width:75%;height:100%;background:linear-gradient(90deg,#6366f1,#8b5cf6);border-radius:6px;"></div></div><span style="font-size:12px;font-weight:700;color:#0f172a;">$7.5K</span></div><div style="display:flex;align-items:center;gap:12px;"><span style="font-size:12px;color:#64748b;width:30px;">Feb</span><div style="flex:1;height:24px;background:#e2e8f0;border-radius:6px;overflow:hidden;"><div style="width:90%;height:100%;background:linear-gradient(90deg,#6366f1,#8b5cf6);border-radius:6px;"></div></div><span style="font-size:12px;font-weight:700;color:#0f172a;">$9.0K</span></div><div style="display:flex;align-items:center;gap:12px;"><span style="font-size:12px;color:#64748b;width:30px;">Mar</span><div style="flex:1;height:24px;background:#e2e8f0;border-radius:6px;overflow:hidden;"><div style="width:60%;height:100%;background:linear-gradient(90deg,#6366f1,#8b5cf6);border-radius:6px;"></div></div><span style="font-size:12px;font-weight:700;color:#0f172a;">$6.0K</span></div></div></div>' },
      { label: 'Donut Chart', tag: 'div', icon: PieChart, description: 'Circular chart', customHtml: '<div style="padding:24px;background:#fff;border:1px solid #e2e8f0;border-radius:16px;margin:16px 0;text-align:center;"><h4 style="font-size:14px;font-weight:700;margin:0 0 16px;color:#0f172a;">Traffic Sources</h4><div style="width:120px;height:120px;border-radius:50%;background:conic-gradient(#6366f1 0% 45%,#f59e0b 45% 70%,#10b981 70% 90%,#e2e8f0 90% 100%);margin:0 auto 16px;display:flex;align-items:center;justify-content:center;"><div style="width:60px;height:60px;background:#fff;border-radius:50%;"></div></div><div style="display:flex;justify-content:center;gap:16px;font-size:12px;"><span style="display:flex;align-items:center;gap:4px;"><span style="width:8px;height:8px;background:#6366f1;border-radius:2px;"></span>Direct 45%</span><span style="display:flex;align-items:center;gap:4px;"><span style="width:8px;height:8px;background:#f59e0b;border-radius:2px;"></span>Social 25%</span><span style="display:flex;align-items:center;gap:4px;"><span style="width:8px;height:8px;background:#10b981;border-radius:2px;"></span>Search 20%</span></div></div>' },
      { label: 'Metric Card', tag: 'div', icon: TrendingUp, description: 'KPI with trend', customHtml: '<div style="padding:24px;background:#fff;border:1px solid #e2e8f0;border-radius:16px;margin:8px 0;"><div style="display:flex;justify-content:space-between;align-items:start;"><div><div style="font-size:12px;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:8px;">Total Revenue</div><div style="font-size:32px;font-weight:900;color:#0f172a;letter-spacing:-0.02em;">$45,231</div></div><div style="padding:6px 10px;background:#dcfce7;border-radius:999px;font-size:12px;font-weight:700;color:#15803d;">↑ 12.5%</div></div><div style="margin-top:16px;height:40px;background:linear-gradient(to right,rgba(99,102,241,0.05),rgba(99,102,241,0.15));border-radius:8px;overflow:hidden;position:relative;"><div style="position:absolute;bottom:0;left:0;right:0;height:60%;background:linear-gradient(to right,#6366f1,#8b5cf6);opacity:0.2;border-radius:0 0 8px 8px;"></div></div></div>' },
    ],
  },
  {
    title: 'Social & Misc',
    ...
    items: [
      ...
      { label: 'Empty State', tag: 'div', icon: Info, description: 'No data placeholder', customHtml: '<div style="text-align:center;padding:48px 24px;"><div style="font-size:48px;margin-bottom:16px;">📭</div><h3 style="font-size:18px;font-weight:700;margin:0 0 8px;color:#0f172a;">No items yet</h3><p style="font-size:14px;color:#94a3b8;margin:0 0 20px;max-width:320px;margin-left:auto;margin-right:auto;">Get started by creating your first item. It only takes a few seconds.</p><button style="padding:12px 24px;background:#6366f1;color:#fff;border:none;border-radius:10px;font-size:14px;font-weight:600;cursor:pointer;">Create Item</button></div>' },
      { label: 'Loading Skeleton', tag: 'div', icon: Loader2, description: 'Content loader', customHtml: '<div style="padding:20px;border:1px solid #e2e8f0;border-radius:16px;margin:16px 0;"><div style="display:flex;gap:12px;margin-bottom:16px;"><div style="width:48px;height:48px;background:#f1f5f9;border-radius:50%;animation:pulse 1.5s ease-in-out infinite;"></div><div style="flex:1;"><div style="height:14px;width:40%;background:#f1f5f9;border-radius:8px;margin-bottom:8px;animation:pulse 1.5s ease-in-out infinite;"></div><div style="height:10px;width:60%;background:#f1f5f9;border-radius:6px;animation:pulse 1.5s ease-in-out infinite;"></div></div></div><div style="height:12px;background:#f1f5f9;border-radius:6px;margin-bottom:10px;animation:pulse 1.5s ease-in-out infinite;"></div><div style="height:12px;width:80%;background:#f1f5f9;border-radius:6px;animation:pulse 1.5s ease-in-out infinite;"></div></div><style>@keyframes pulse{0%,100%{opacity:1}50%{opacity:0.5}}</style>' },
      { label: 'Kbd Shortcut', tag: 'div', icon: Code2, description: 'Keyboard shortcut', customHtml: '<div style="display:inline-flex;align-items:center;gap:4px;"><kbd style="padding:4px 8px;background:#f8fafc;border:1px solid #e2e8f0;border-bottom:2px solid #cbd5e1;border-radius:6px;font-size:12px;font-family:monospace;color:#475569;">⌘</kbd><kbd style="padding:4px 8px;background:#f8fafc;border:1px solid #e2e8f0;border-bottom:2px solid #cbd5e1;border-radius:6px;font-size:12px;font-family:monospace;color:#475569;">K</kbd></div>' },
    ],
  },
];
